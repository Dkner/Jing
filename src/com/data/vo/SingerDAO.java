...
public class SingerDAO extends BaseHibernateDAO {
	...
	public Singer findById(java.lang.Integer id) {
		...
		try {
			Singer instance = (Singer) getSession().get("com.data.vo.Singer",
					id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Singer instance) {
		...
		try {
			List results = getSession().createCriteria("com.data.vo.Singer")
	...
	public List findByBriefing(Object briefing) {
